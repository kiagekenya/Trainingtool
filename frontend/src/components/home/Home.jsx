...
<div className="box" data-aos="zoom-in">
   ...
   <Link to="/under" className="inline-btn" >View Module</Link>
      ...
      <section className='home-grid'>
        <h1 className="heading" data-aos="fade-right">quick options</h1>
        ...
        <div className="box" data-aos="zoom-in">
         ...
         <p className="likes">saved courses: <span>4</span></p>
      ...
      <div className="box" data-aos="fade-up">
         ...
         <div className="flex">
            <Link to="/"><span>drilling engineering</span></Link>
            <Link to="/"><span>exploratory drilling</span></Link>
            <Link to="/"><span>reservoir simulation</span></Link>
            <Link to="/"><span>marketing</span></Link>
            <Link to="/"><span>petroleum geology</span></Link>
            <Link to="/"><span>production engineering</span></Link>
            <Link to="/"><span>petrophysics</span></Link>
            <Link to="/"><span>Gas</span></Link>
      ...
      <div className="box" data-aos="fade-down">
         ...
         <div className="flex">
            <Link to="/"><span>Safety and training</span></Link>
            <Link to="/"><span>Natural Environment</span></Link>
            <Link to="/"><span>Artificial lift systems</span></Link>
            <Link to="/"><span>Effects on climate</span></Link>
            <Link to="/"><span>Petroleum</span></Link>
            <Link to="/"><span>Drilling technology</span></Link>
         </div>
      </div>
      ...
      <div className="box" data-aos="flip-left">
         ...
         <Link to="/" class="inline-btn">Get started</Link>
      </div>
