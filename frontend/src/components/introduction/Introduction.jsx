    ...
    <section className="playlist-videos">
        ...
        <div className="box-container">
          ...
          {showNotes && (
            <div className="notes">
              {/* Notes content */}
              <p>Oil and gas are natural resources found beneath the Earth's surface that consist primarily of hydrocarbons, which are organic compounds composed of hydrogen and carbon atoms. They are crucial sources of energy and raw materials for various industries. Here's a breakdown of each:

              <ol>
                <li><strong>Oil (Crude Oil)</strong>:
                  <ul data-aos="zoom-in">
              ...
              The extraction, refining, and distribution of oil and gas form the backbone of the global energy industry, playing a central role in driving economic growth and meeting the energy needs of societies worldwide.
              </p>
            </div>
          )}
        </div>
